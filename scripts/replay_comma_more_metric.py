...
from car_motion_attack.replay_metric import ReplayMetric
...
if model_type not in ('laneatt', 'ultrafast', 'scnn', 'polylanenet', 'nan'):
...
def main(row, offset):
    ...
    config = {}    
    config['result_dir'] = f'logs/comma_benign/replay_{model_type}_more/{row.sc_name}/'
